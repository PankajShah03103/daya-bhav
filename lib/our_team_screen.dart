...
class OurTeamScreen extends StatefulWidget {
  ...
  @override
  State<OurTeamScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<OurTeamScreen> {
  @override
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Text(
            "Founded to save lives and speak out, DWF teams have cared for tens of millions of birds and animals since 2020.",
            style: TextStyle(
                color: impactBgColor,
