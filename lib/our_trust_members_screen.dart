...
class OurTrustMembersScreen extends StatefulWidget {
  const OurTrustMembersScreen({
    super.key,
  });

  @override
  State<OurTrustMembersScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<OurTrustMembersScreen> {
  @override
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Text(
            "Helped to save lives and speak out, DWF teams have cared for tens of millions of birds and animals since 2020.",
            style: TextStyle(
                color: impactBgColor,
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    cardDonateBox("Sanjay Jain (Lalitpur)", "+91 - 9616000016",
  ...
  Widget cardDonateBox(
      String nameText, String phoneNumber, dynamicWidth, dynamicHeight) {
    return Padding(
      padding: EdgeInsets.only(
